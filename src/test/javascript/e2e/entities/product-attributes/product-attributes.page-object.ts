...
export class ProductAttributesComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-product-attributes div table .btn-danger'));
  title = element.all(by.css('jhi-product-attributes div h2#page-heading span')).first();
...
export class ProductAttributesUpdatePage {
  pageTitle = element(by.id('jhi-product-attributes-heading'));
...
export class ProductAttributesDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-productAttributes-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-productAttributes'));
