...
export class DeliveryOptionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-delivery-option div table .btn-danger'));
  title = element.all(by.css('jhi-delivery-option div h2#page-heading span')).first();
...
export class DeliveryOptionUpdatePage {
  pageTitle = element(by.id('jhi-delivery-option-heading'));
...
export class DeliveryOptionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-deliveryOption-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-deliveryOption'));
