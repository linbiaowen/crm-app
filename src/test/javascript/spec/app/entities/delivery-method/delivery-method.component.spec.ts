...
import { DeliveryMethodComponent } from 'app/entities/delivery-method/delivery-method.component';
...
describe('Component Tests', () => {
  describe('DeliveryMethod Management Component', () => {
    let comp: DeliveryMethodComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DeliveryMethodComponent, '')
        .compileComponents();
