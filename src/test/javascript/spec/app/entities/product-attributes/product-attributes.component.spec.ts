...
import { ProductAttributesComponent } from 'app/entities/product-attributes/product-attributes.component';
...
describe('Component Tests', () => {
  describe('ProductAttributes Management Component', () => {
    let comp: ProductAttributesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductAttributesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ProductAttributes('123')],
            headers
          })
        )
      );
